...
:: iOS packaging
set IOS_DIST_CERT_FILE=c:\tmp\iPhone.p12
set IOS_DEV_CERT_FILE=c:\tmp\iPhone.p12
set IOS_DEV_CERT_PASS=fd
set IOS_PROVISION=c:\tmp\iPhone.mobileprovision
...
set APP_ID=air.com.fortumo.demo.demo
